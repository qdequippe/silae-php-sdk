...
class SWSUtilisateurContactDossierRecupererPeriodeEnCours implements RequestInterface
{
    /**
     * @var string
     */
     ...
     * @var int $ID_DROIT
     */
    public function __construct($Token, $ID_DOMAINE, $ID_CLIENT, $ID_DROIT)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurContactDossierRecupererPeriodeEnCours
     */
