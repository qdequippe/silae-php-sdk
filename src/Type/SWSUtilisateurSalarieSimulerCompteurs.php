...
class SWSUtilisateurSalarieSimulerCompteurs implements RequestInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($Token, $ID_DOMAINE, $ID_PAISALARIE, $PeriodeSimulation)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurSalarieSimulerCompteurs
     */
