...
class SWSUtilisateurContactAcquisitionSA implements RequestInterface
{
    /**
     * @var string
     */
    ...
    /**
     * @var \Qdequippe\SilaePhpSdk\Type\CPAISWSArgumentSA
     */
    private $ArgumentSA;
     ...
     * @var int $ID_CLIENT
     * @var int $ID_DROIT
     * @var \Qdequippe\SilaePhpSdk\Type\CPAISWSArgumentSA $ArgumentSA
     */
    public function __construct($Token, $ID_DOMAINE, $ID_CLIENT, $ID_DROIT, $ArgumentSA)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurContactAcquisitionSA
     */
    ...
    /**
     * @return \Qdequippe\SilaePhpSdk\Type\CPAISWSArgumentSA
     */
    ...
    /**
     * @param \Qdequippe\SilaePhpSdk\Type\CPAISWSArgumentSA $ArgumentSA
     * @return SWSUtilisateurContactAcquisitionSA
     */
