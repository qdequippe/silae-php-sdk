...
class SWSUtilisateurContactAjouterAcompte implements RequestInterface
{
    /**
     * @var string
     */
     ...
     * @var int $ID_CLIENT
     * @var int $ID_DROIT
     * @var \Qdequippe\SilaePhpSdk\Type\CPAISWSAcompteTM $Acompte
     */
    public function __construct($Token, $ID_DOMAINE, $ID_CLIENT, $ID_DROIT, $Acompte)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurContactAjouterAcompte
     */
    ...
    /**
     * @param \Qdequippe\SilaePhpSdk\Type\CPAISWSAcompteTM $Acompte
     * @return SWSUtilisateurContactAjouterAcompte
     */
