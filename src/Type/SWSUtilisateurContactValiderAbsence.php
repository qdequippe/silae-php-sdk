...
class SWSUtilisateurContactValiderAbsence implements RequestInterface
{
    /**
     * @var string
     */
    ...
    /**
     * @var \Qdequippe\SilaePhpSdk\Type\CPAISWSArgumentGestionMail
     */
    private $ArgEnrAbs;
     ...
     * @var \Qdequippe\SilaePhpSdk\Type\CPAISWSArgumentGestionMail $ArgEnrAbs
     */
    public function __construct($Token, $ID_DOMAINE, $ID_CLIENT, $ID_DROIT, $ID_PAISALARIE, $ID_PAIABSENCE, $ArgEnrAbs)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurContactValiderAbsence
     */
    ...
    /**
     * @return \Qdequippe\SilaePhpSdk\Type\CPAISWSArgumentGestionMail
     */
    public function getArgEnrAbs()
    {
        return $this->ArgEnrAbs;
    }

    /**
     * @param \Qdequippe\SilaePhpSdk\Type\CPAISWSArgumentGestionMail $ArgEnrAbs
     * @return SWSUtilisateurContactValiderAbsence
     */
    public function withArgEnrAbs($ArgEnrAbs)
    {
        $new = clone $this;
        $new->ArgEnrAbs = $ArgEnrAbs;
