...
class SWSUtilisateurContactModifierAbsence implements RequestInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($Token, $ID_DOMAINE, $ID_CLIENT, $ID_DROIT, $Absence, $ArgEnrAbs)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurContactModifierAbsence
     */
