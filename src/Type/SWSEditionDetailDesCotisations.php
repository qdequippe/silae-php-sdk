...
class SWSEditionDetailDesCotisations implements RequestInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($Token, $NumeroDossier, $PeriodeDebut, $PeriodeFin)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSEditionDetailDesCotisations
     */
