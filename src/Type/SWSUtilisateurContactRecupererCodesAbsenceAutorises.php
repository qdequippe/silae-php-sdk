...
class SWSUtilisateurContactRecupererCodesAbsenceAutorises implements RequestInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($Token, $ID_DOMAINE, $ID_CLIENT, $ID_DROIT, $ID_PAISALARIE, $PeriodeDebut, $PeriodeFin)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurContactRecupererCodesAbsenceAutorises
     */
