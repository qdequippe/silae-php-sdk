...
class SWSUtilisateurSuperviseurRecupererCodesAbsenceAutorisesPourSalarie implements RequestInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($Token, $ID_DOMAINE, $ID_SUPERVISEUR, $ID_PAISALARIE, $PeriodeDebut, $PeriodeFin)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurSuperviseurRecupererCodesAbsenceAutorisesPourSalarie
     */
