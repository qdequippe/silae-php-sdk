...
class SWSUtilisateurContactAcquisitionSalariesFiltre implements RequestInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($Token, $ID_DOMAINE, $ID_CLIENT, $ID_DROIT, $Periode)
    {
        $this->Token = $Token;
    ...
    /**
     * @param string $Token
     * @return SWSUtilisateurContactAcquisitionSalariesFiltre
     */
